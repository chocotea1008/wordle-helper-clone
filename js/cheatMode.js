...
const PRECALCULATED_STARTERS = {
    ...
    7: {
        total: "33,004",
        list: [
            { word: "상고지", strategy: "최고 추천 (총점)", reason: "7개 서로 다른 자모(ㅅ,ㅏ,ㅇ,ㄱ,ㅗ,ㅈ,ㅣ)로 995가지 경우의 수를 가르는 최적 단어입니다.", remain: "104.6개" },
            { word: "골아지", strategy: "강력 추천 (유저 선호)", reason: "7개 알짜 자모(ㄱ,ㅗ,ㄹ,ㅇ,ㅏ,ㅈ,ㅣ)로 구성되어 매우 뛰어난 정보 획득률을 보입니다.", remain: "109.1개" },
            { word: "알구지", strategy: "자모 다양성", reason: "모음(ㅏ,ㅜ,ㅣ)과 자음(ㅇ,ㄹ,ㄱ,ㅈ) 7개를 모두 검사하여 빠른 필터링을 자랑합니다.", remain: "109.4개" },
            { word: "옷가지", strategy: "대표 일상 단어", reason: "자음 ㅇ,ㅅ,ㄱ,ㅈ 및 모음 ㅗ,ㅏ,ㅣ 조합으로 높은 감축률을 기록합니다.", remain: "111.0개" },
            { word: "상조기", strategy: "정보량 탐색", reason: "안정적인 자음/모음 분포로 초반 힌트를 획득하기에 유용한 단어입니다.", remain: "113.8개" }
        ]
    }
};
